// Serves a demo rss feed and the content under /web
...
// false to make available at puffinlabs.me (the latter only works when port
// forwarding is set up and dns points to correct IP)
const expose = false;
...
Future main() async {
  ...
  await for (var request in server) {
    ...
    if (request.uri.path == '/') {
      ...
      // Feed request. Look it up in the map.
